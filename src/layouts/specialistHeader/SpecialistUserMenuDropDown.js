...
function SpecialistUserMenuDropDown({ open, onClose, Ele }) {
  ...
  return (
    <div
      id="dropdown"
      className={`animate-fadeOpen z-10 w-44 bg-white rounded-xl divide-y divide-gray-100 shadow-xl dark:bg-gray-700 absolute mt-[0.2rem] ml-[10.5rem] p-1 ${
        open ? '' : 'hidden'
      }`}
      ref={dropdownEl}
...
export default SpecialistUserMenuDropDown;
